const Colors = {
    ...
    liniarColorProduct:['#1aa5c6', '#0455ad'],
    liniarColorHome:['#5128a1', '#aa31c4'],
    liniarColorLogin:['rgba(170,49,196,.5)','rgba(81,40,161,.9)'],
    gray_light:'#e6e6e6',
    secondColor:'#a93dc5',
    backGroundColor:'#f6f6f6',
    tabBarColor:'#ffffff',
    purpule:'#aa31c4',
    disbaleLoginColor:['rgba(156, 39, 176,.2)', 'rgba(149, 117, 205,.6)'],
    enableLoginColor:['rgb(156, 39, 176)', 'rgb(149, 117, 205)'],
    light_black:'#BDBDBD'
}
